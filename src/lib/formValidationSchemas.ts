...
export const newStudentSchema = z.object({
  ...
  username: z
    .string()
    .min(4, { message: "Nama Pengguna Setidaknya 4 Karakter!" })
    .max(20, { message: "Nama Pengguna tidak boleh melebihi 20 Karakter!" }),
  password: z
    .string()
    .min(8, { message: "Kata Sandi Paling sedikit 8 karakter" })
    .optional()
    .or(z.literal("")),
  name: z.string().min(1, { message: "Nama Depan dibutuhkan !" }),
  surname: z.string().min(1, { message: "Nama Belakang dibutuhkan !" }),
  email: z
    .string()
    .email({ message: "Format Email Tidak tepat!" })
    .optional()
  ...
  address: z.string(),
  img: z.string().optional(),
  imgKartuKeluarga: z.string().optional(),
  imgAktaKelahiran: z.string().optional(),
  bloodType: z.string().min(1, { message: "Golongan darah dibutuhkan!" }),
  birthday: z.coerce.date({ message: "Tanggal Ulang Tahun dibutuhkan!" }),
  sex: z.enum(["MALE", "FEMALE"], { message: "Jenis Kelamin dibutuhkan!" }),
  gradeId: z.coerce.number().min(1, { message: "Tingkatan dibutuhkan!" }),
  classId: z.coerce.number().min(1, { message: "Kelas dibutuhkan!" }),
  parentId: z.string({ message: "Orang TuaID dibutuhkan!" }).optional(),
});
